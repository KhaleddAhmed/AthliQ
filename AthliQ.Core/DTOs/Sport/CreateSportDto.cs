...
namespace AthliQ.Core.DTOs.Sport
{
    public class CreateSportDto
    {
        ...
        [StringLength(30, ErrorMessage = "Sport Arabic Name Can Not Contain More Than 30 Charachter")]
        public string ArabicName { get; set; }

        [Required(ErrorMessage = "Sport Description Is Required")]
        [StringLength(100, ErrorMessage = "Sport Description Can Not Contain More Than 100 Charachter")]
